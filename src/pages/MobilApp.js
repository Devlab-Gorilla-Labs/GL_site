                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <SectionTitle
                                    ...
                                    radiusRounded=""
                                    description=""
                                    title="¿Cuentas con app en tu negocio o idea?"
                                />
                            </div>
                        </div>

                        <Split2
                            img="./images/split/app-945x709.svg"
                            title="Materializa tu idea o negocio"
                            desc="El futuro es hoy viejo, y si tu negocio no lo acercas a las tecnologias,
                            muy seguramente no tendra oportunidad ante las empresas que inviertan en sistematizar
                            y digitalizar su negocio. Al tener una app para tu negocio o idea de emprendimiento,
                            quitas las limitacions que tiene un negocio fisico y horarios estrictos."
                        />
