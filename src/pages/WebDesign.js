...
const ServiceList = [
    ...
    },
    {
        ...
        description: 'Si tu negocio va bien o mal, y no cuentas con website; te estas perdiendo de un mercado GIGANTE que existe en internet.'
    },
    {
    ...
    {
        icon: <FcFinePrint />,
        title: 'Posicióna tu Marca',
        description: 'Muestra esa seguridad y confiabilidad que esperas mostrar de tu negocio. Si esta en internet, debe de ser bueno.'
    },
    {
        icon: <FcStatistics />,
        title: 'Google ads & SEO',
        description: '¡No Te Limites! Las posibilidades de llegar a tu cliente ideal aumentan con la publicidad de paga y organica.'
    },
]
...
const points = [
    ...
    "Tu negocio abierto 24/7 para quien lo busque.",
    "Crearas una muy buena primera impresion.",
