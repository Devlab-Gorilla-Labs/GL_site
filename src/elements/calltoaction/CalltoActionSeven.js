...
const callToActionData = {
    ...
    subtitle: "Si quieres mas informacion....",
                    ...
                    <div className="col-lg-4 col-md-4">
                        ...
                        animateOnce={true}>
                            <div className="call-to-btn text-start mt_sm--20 text-md-end">
                                <a className="btn-default btn-icon" target="_blank" href="https://ketzal.app">{callToActionData.btnText} <i className="icon"><FiArrowRight /></i></a>
                            </div>
                        </ScrollAnimation>
                    </div>
                </div>
