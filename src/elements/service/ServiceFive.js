...
const ServiceList = [
    {
        ...
        title: 'Websites',
        description: 'Creamos tu sitio web profesional.'
    },
    {
        image: '/images/service/galery-image-02.png',
        title: 'Apps y E-Commerce',
        description: 'Inicia tu tienda en linea.'
    },
    {
        image: '/images/service/galery-image-03.png',
        title: 'Marketing',
        description: 'Te ayudamos a que te vean.'
    }
]
                        ...
                        <div className={`service ${serviceStyle} ${textAlign}`}>
                            <div className="inner">
                                <div className="content">
                                    <h4 className="title">
                                        <Link to="/web-design" dangerouslySetInnerHTML={{__html: val.title}}></Link>
                                    </h4>
