                        ...
                        <div className="col-lg-12">
                            <div className="inner">
                                <div className="content">
                                    <span className="rn-badge">Oferta Limitada</span>
                                    <span className="news-text">Obten Tu Website x <strong>450 dlls.</strong></span>
                                </div>
                                <div className="right-button">
                                    <a className="btn-read-more" target="_blank" href="/web-design"><span>Lo Quiero<FiArrowRight /></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
