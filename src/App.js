...
import Domain from './pages/BScnWz2NPlh9_PVBxshm_-TOMVmnGZcdxuEAx7xGRh8';
...
const App = () => {
    ...
    // state para la posicion del mous
    ...
    // obtener las coordenadas de la posicion delouse
        ...
        <HashRouter>
            <PageScrollTop>
                <Switch>
                    ...
                    <Route path={`${process.env.PUBLIC_URL + "/web-design"}`} exact component={WebDesign} />
                    <Route path={`${process.env.PUBLIC_URL + "/.well-known/acme-challenge"}`} exact component={Domain} />
                    <Route path={`${process.env.PUBLIC_URL + "/politica-privacidad"}`} exact component={Privacy} />
                    <Route path={`${process.env.PUBLIC_URL + "/e-commerce"}`} exact component={ECommerce} />
                    <Route path={`${process.env.PUBLIC_URL + "/mobil-app"}`} exact component={MobilApp} />


                    {/* Blog Part  */}
                    <Route path={`${process.env.PUBLIC_URL + "/admin-blog"}`} exact component={PostBlog} />
